...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = "weatherstreamingnamespace0.servicebus.windows.net"
    ...
    def fetch_weather_data():
        ...
        #Fetching the API key from Key Vault
        VAULT_URL = "https://kv-weather-streaming01.vault.azure.net/"
        API_KEY_SECET_NAME = "weatherapikey"
        weatherapikey = get_secret_from_keyvault(VAULT_URL, API_KEY_SECET_NAME)
