...
eventhub_connection_string = dbutils.secrets.get(scope="kv-weather-streaming01",key="eventhub-connection-string")

EVENT_HUB_NAME = "weatherstreamingevenhub"
...
# Getting secret value from Key Vault
weatherapikey = dbutils.secrets.get(scope="kv-weather-streaming01", key="weatherapikey")
location = "Barranquilla"  # You can replace with city name based on your preference
...
def fetch_weather_data():
    ...
    base_url = "http://api.weatherapi.com/v1/"
    location = "Barranquilla"  # You can replace with any city name based on your preference
    weatherapikey = dbutils.secrets.get(scope="kv-weather-streaming01", key="weatherapikey")
